...
uint8_t B_VIntDwPin=P10;
uint8_t B_VExtDwPin=P11;
uint8_t B_VIntUpPin=P12;
uint8_t B_VExtUpPin=P13;
uint8_t B_WSClosePin=P14;
uint8_t B_WSpcmPin=P15;
...
delay(5000);//Time to Serial monitor starts
...
void Time(){
  ...
  sys_temp=String(SimMode,DEC)+";"+String(TExt,3)+";"+String(TInt,3)+";"+String(TWUp,3)+";"+String(TWDw,3)+";";
